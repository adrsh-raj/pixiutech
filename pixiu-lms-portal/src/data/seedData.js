...
export const CLASS_KITS = {
  ...
  '7': {
    ...
    total_components: 12,
    components: [
      { id: 'C7-01', name: 'Arduino Uno R3 Board', image: '/img/kits/components/class7_part_1.jpg', role: 'The Brain controller for environmental and smart automation logic.', session: 'Session 3', category: 'Controller', specs: 'ATmega328P, 16 MHz crystal oscillator, 5V regulated' },
      { id: 'C7-02', name: 'USB A-B Cable', image: '/img/kits/components/class7_part_2.jpg', role: 'Carries code program into the board and powers it during lab sessions.', session: 'Session 3', category: 'Interface', specs: 'Standard USB 2.0 A-B data lead' },
      { id: 'C7-03', name: '400-Point Breadboard', image: '/img/kits/components/class7_part_3.jpg', role: 'Solderless prototyping circuit base with dual power rails.', session: 'Session 2', category: 'Prototyping', specs: 'ABS thermoplastic block with nickel-plated spring contacts' },
      { id: 'C7-04', name: 'Jumper Wire Set', image: '/img/kits/components/class7_part_4.jpg', role: 'Circuit links for sensor modules, potentiometers and actuators.', session: 'Session 2', category: 'Wiring', specs: 'Male-to-Male and Male-to-Female flexible jumpers' },
      { id: 'C7-05', name: '5mm LED Indicators', image: '/img/kits/components/class7_part_5.jpg', role: 'Status indicator lamps for alarm thresholds and environmental indicators.', session: 'Session 2', category: 'Visual Output', specs: '5mm high-efficiency semiconductor LEDs' },
      { id: 'C7-06', name: '220Ω Resistors', image: '/img/kits/components/class7_part_6.jpg', role: 'Current limiters protecting indicator diodes from burn-out.', session: 'Session 2', category: 'Passive', specs: '220 Ohm, 0.25W metal film resistor pack' },
      { id: 'C7-07', name: '10KΩ Rotary Potentiometer', image: '/img/kits/components/class7_part_7.jpg', role: 'A knob that gives a smoothly changing 0-5V voltage level - your first analog input.', session: 'Session 6', category: 'Analog Input', specs: 'Linear taper 10K Ohm pot with 3-pin solderless headers' },
      { id: 'C7-08', name: 'DHT11 Temperature & Humidity Sensor', image: '/img/kits/components/class7_part_8.jpg', role: 'Measures ambient room temperature (0-50°C) and relative humidity (20-90%), both from one sensor.', session: 'Session 9', category: 'Sensor', specs: 'Single-bus digital signal output, calibrated NTC thermistor & capacitive polymer' },
      { id: 'C7-09', name: 'Active Piezo Buzzer Module', image: '/img/kits/components/class7_part_9.jpg', role: 'Produces high-pitch acoustic sirens when environmental thresholds trigger.', session: 'Session 11', category: 'Audio Output', specs: 'Active 5V audio transducer with onboard drive transistor' },
      { id: 'C7-10', name: 'Raindrop & Moisture Detection Plate', image: '/img/kits/components/class7_part_10.jpg', role: 'Dual-sided conductive nickel grid tracking rain droplets and surface moisture.', session: 'Session 12', category: 'Sensor', specs: 'FR-04 gold-plated rain sensor board + LM393 comparator module' },
      { id: 'C7-11', name: 'LDR Ambient Light Sensor Module', image: '/img/kits/components/class7_part_11.jpg', role: 'Light dependent resistor module detecting sunrise, dusk and illumination levels.', session: 'Session 13', category: 'Sensor', specs: 'Photo-conductive cadmium sulfide sensor with analog/digital output' },
      { id: 'C7-12', name: 'SG90 Micro Servo Actuator', image: '/img/kits/components/class7_part_12.jpg', role: 'Geared motor rotating to precise angular positions for automated smart wipers & flaps.', session: 'Session 15', category: 'Actuator', specs: '9g servo, nylon gear train, 180° rotation angle' }
    ]
  },
  '8': {
    class_grade: '8',
    ...
    total_components: 12,
    components: [
      { id: 'C8-01', name: 'Arduino Uno R3 Board', image: '/img/kits/components/class8_part_1.jpg', role: 'Central robotics controller running navigation and motor algorithms.', session: 'Session 3', category: 'Controller', specs: 'Microchip ATmega328P with 32KB flash memory' },
      { id: 'C8-02', name: 'USB A-B Cable', image: '/img/kits/components/class8_part_2.jpg', role: 'High-speed interface for firmware upload and debugging.', session: 'Session 3', category: 'Interface', specs: 'Shielded USB-A to USB-B cable' },
      { id: 'C8-03', name: '400-Point Breadboard', image: '/img/kits/components/class8_part_3.jpg', role: 'Wiring board for sonar sensor and motor driver connections.', session: 'Session 2', category: 'Prototyping', specs: '400 tie-point prototyping platform' },
      { id: 'C8-04', name: 'Jumper Wire Set', image: '/img/kits/components/class8_part_4.jpg', role: 'Signal interconnect cables between Arduino, motor driver and sensors.', session: 'Session 2', category: 'Wiring', specs: 'Ribbon jumper pack with durable male/female crimped pins' },
      { id: 'C8-05', name: '5mm LED Bar Array', image: '/img/kits/components/class8_part_5.jpg', role: 'Visual distance gauge indicating approaching obstacles in real-time.', session: 'Session 2', category: 'Visual Output', specs: '5mm diffused colored diodes' },
      { id: 'C8-06', name: '220Ω Resistors', image: '/img/kits/components/class8_part_6.jpg', role: 'Limits drive current to status indicators.', session: 'Session 2', category: 'Passive', specs: '220 Ohm metal film resistors' },
      { id: 'C8-07', name: 'HC-SR04 Sonar Ultrasonic Sensor', image: '/img/kits/components/class8_part_7.jpg', role: 'Measures spatial distance by timing high-frequency acoustic echo pulses. The star of this book.', session: 'Session 6', category: 'Sensor', specs: '40 kHz ultrasound transducer pair, 2cm-400cm sensing distance' },
      { id: 'C8-08', name: 'SG90 Sonar Turret Servo Motor', image: '/img/kits/components/class8_part_8.jpg', role: 'Rotates the ultrasonic sensor across 180° to scan for obstacles left and right.', session: 'Session 9', category: 'Actuator', specs: 'Micro servo with horns and mounting screws' },
      { id: 'C8-09', name: 'Buzzer Warning Module', image: '/img/kits/components/class8_part_9.jpg', role: 'Emits proximity warning tone as obstacles get closer.', session: 'Session 10', category: 'Audio Output', specs: 'Piezo buzzer unit' },
      { id: 'C8-10', name: 'L298N Dual H-Bridge Motor Driver', image: '/img/kits/components/class8_part_10.jpg', role: 'High-current power amplifier driving dual DC gear motors with direction & speed PWM.', session: 'Session 12', category: 'Motor Driver', specs: 'Dual full-bridge driver, 2A peak per channel, heavy aluminum heatsink' },
      { id: 'C8-11', name: '100 RPM Geared BO Motors & Wheels (x2)', image: '/img/kits/components/class8_part_11.jpg', role: 'Dual drive motors delivering high torque for robot movement.', session: 'Session 13', category: 'Motors & Wheels', specs: 'Dual-shaft 3-6V DC gear motors with rubber grip traction wheels' },
      { id: 'C8-12', name: 'Robot Chassis, Caster Wheel & Battery Pack', image: '/img/kits/components/class8_part_12.jpg', role: 'Laser-cut acrylic robot chassis, omni caster, switch & battery holder.', session: 'Session 13', category: 'Mechanical Chassis', specs: 'Acrylic base, metal ball caster wheel, 4xAA battery enclosure' }
    ]
  },
  '9': {
    class_grade: '9',
    ...
    total_components: 16,
    components: [
      { id: 'C9-01', name: 'Arduino Uno R3 Board', image: '/img/kits/components/class9_part_1.jpg', role: 'Central processing unit executing multi-sensor arbitration and line tracking loops.', session: 'Session 3', category: 'Controller', specs: 'ATmega328P 8-bit RISC processor' },
      { id: 'C9-02', name: 'USB A-B Cable', image: '/img/kits/components/class9_part_2.jpg', role: 'High integrity programming and serial data communication cable.', session: 'Session 3', category: 'Interface', specs: 'Full speed USB 2.0 interface' },
      { id: 'C9-03', name: '400-Point Breadboard', image: '/img/kits/components/class9_part_3.jpg', role: 'High quality solderless platform for LCD and sensor wiring.', session: 'Session 2', category: 'Prototyping', specs: '400 tie-points' },
      { id: 'C9-04', name: 'Jumper Wire Harness', image: '/img/kits/components/class9_part_4.jpg', role: 'Interconnection ribbon with multi-pin jumper connections.', session: 'Session 2', category: 'Wiring', specs: 'Premium jumper wires' },
      { id: 'C9-05', name: '5mm Status LEDs', image: '/img/kits/components/class9_part_5.jpg', role: 'Fire, line tracking, and operational status indication.', session: 'Session 2', category: 'Visual Output', specs: 'Diffused 5mm LEDs' },
      { id: 'C9-06', name: '220Ω & 10KΩ Resistors', image: '/img/kits/components/class9_part_6.jpg', role: 'Current limiters and pull-down network for manual switches.', session: 'Session 2', category: 'Passive', specs: 'Metal film resistors' },
      { id: 'C9-07', name: 'Optical Infrared Flame Sensor Module', image: '/img/kits/components/class9_part_7.jpg', role: 'Detects 760nm - 1100nm infrared radiation emitted by real flame sources.', session: 'Session 6', category: 'Sensor', specs: 'High-sensitivity phototransistor with LM393 threshold comparator' },
      { id: 'C9-08', name: 'DHT11 Temp & Humidity Module', image: '/img/kits/components/class9_part_8.jpg', role: 'Secondary environmental confirmation telemetry to verify what the flame sensor saw.', session: 'Session 7', category: 'Sensor', specs: 'Digital temperature & relative humidity sensor' },
      { id: 'C9-09', name: 'Active Alarm Buzzer Module', image: '/img/kits/components/class9_part_9.jpg', role: 'Acoustic siren alerting emergency conditions.', session: 'Session 7', category: 'Audio Output', specs: 'Active 5V piezo sounder' },
      { id: 'C9-10', name: '2-Pin Reset Push Switch', image: '/img/kits/components/class9_part_10.jpg', role: 'Human override switch to clear latched alarms and start runs.', session: 'Session 8', category: 'Input Switch', specs: 'Tactile switch' },
      { id: 'C9-11', name: '16x2 Alphanumeric LCD Display', image: '/img/kits/components/class9_part_11.jpg', role: 'Displays real-time sensor readings and robot telemetry without needing a laptop.', session: 'Session 9', category: 'Display', specs: 'HD44780 standard parallel LCD, 16 characters x 2 rows, blue backlight' },
      { id: 'C9-12', name: '10K LCD Contrast Potentiometer', image: '/img/kits/components/class9_part_12.jpg', role: 'Calibrates the LCD V0 bias contrast voltage for razor-sharp character visibility.', session: 'Session 10', category: 'Analog Input', specs: '10K rotary trimmer potentiometer' },
      { id: 'C9-13', name: 'LDR Ambient Light Sensor', image: '/img/kits/components/class9_part_13.jpg', role: 'Evaluates ambient lux and room lighting conditions.', session: 'Session 11', category: 'Sensor', specs: 'Cadmium sulfide photoresistor module' },
      { id: 'C9-14', name: 'Dual TCRT5000 IR Line Sensor Modules', image: '/img/kits/components/class9_part_14.jpg', role: 'Infrared reflective sensors tracking black/white track contrast on the ground.', session: 'Session 12', category: 'Navigation Sensor', specs: 'TCRT5000 infrared emitter-phototransistor pair with comparator' },
      { id: 'C9-15', name: 'L298N Dual Motor Driver Module', image: '/img/kits/components/class9_part_15.jpg', role: 'H-bridge motor driver managing forward, reverse, and differential steering.', session: 'Session 12', category: 'Motor Driver', specs: 'Dual H-Bridge driver with 5V onboard regulator' },
      { id: 'C9-16', name: 'Line Follower Robot Chassis, Wheels & Power', image: '/img/kits/components/class9_part_16.jpg', role: 'Mobile robot base with twin drive motors, wheels, and battery harness.', session: 'Session 13', category: 'Chassis & Power', specs: 'Acrylic platform, 2x BO motors, caster & 4xAA battery pack' }
    ]
  },
  '11': {
    class_grade: '11',
    ...
    total_components: 16,
    components: [
      { id: 'C11-01', name: 'Arduino Uno R3 Microcontroller', image: '/img/kits/components/class11_part_1.jpg', role: 'Industrial-grade MCU managing laser trip timing, characterization, and maze solver algorithms.', session: 'Session 3', category: 'Controller', specs: 'ATmega328P 16MHz processor' },
      { id: 'C11-02', name: 'USB A-B Interface Cable', image: '/img/kits/components/class11_part_2.jpg', role: 'Serial telemetry transmission and programming lead.', session: 'Session 3', category: 'Interface', specs: 'High-speed shielded A-B cable' },
      { id: 'C11-03', name: '400-Point Breadboard', image: '/img/kits/components/class11_part_3.jpg', role: 'Prototyping platform with high contact reliability.', session: 'Session 2', category: 'Prototyping', specs: '400 tie points' },
      { id: 'C11-04', name: 'Precision Jumper Wire Harness', image: '/img/kits/components/class11_part_4.jpg', role: 'Interconnect wires for sensor arrays and logic stages.', session: 'Session 2', category: 'Wiring', specs: 'Male-Male, Male-Female, Female-Female' },
      { id: 'C11-05', name: '5mm Multi-State Indication LEDs', image: '/img/kits/components/class11_part_5.jpg', role: 'System status indicators: Armed, Warning, Alarm and Running.', session: 'Session 2', category: 'Visual Output', specs: '5mm high brightness LEDs' },
      { id: 'C11-06', name: '220Ω & 10KΩ Precision Resistors', image: '/img/kits/components/class11_part_6.jpg', role: 'Current limiting and pull-down network resistors.', session: 'Session 2', category: 'Passive', specs: '1% metal film precision resistors' },
      { id: 'C11-07', name: '5V 650nm Red Laser Dot Diode Module', image: '/img/kits/components/class11_part_7.jpg', role: 'Emits a tight, collimated 650nm coherent red optical beam for perimeter tripwire defense.', session: 'Session 6', category: 'Optics / Emitter', specs: '650nm red semiconductor laser diode, 5mW, adjustable brass collimating lens' },
      { id: 'C11-08', name: 'High-Sensitivity Optical LDR Receiver', image: '/img/kits/components/class11_part_8.jpg', role: 'High-speed light sensor aligned with the laser beam to instantly detect tripwire breaks.', session: 'Session 6', category: 'Optics / Sensor', specs: 'Photoresistor module with adjustable comparator threshold' },
      { id: 'C11-09', name: '16x2 Telemetry LCD Display', image: '/img/kits/components/class11_part_9.jpg', role: 'Live engineering screen displaying trip counts, response time in milliseconds & distance.', session: 'Session 7', category: 'Display', specs: '16x2 HD44780 LCD module' },
      { id: 'C11-10', name: '10K Contrast Potentiometer', image: '/img/kits/components/class11_part_10.jpg', role: 'Fine-tunes display contrast voltage.', session: 'Session 7', category: 'Analog Input', specs: 'Precision 10K pot' },
      { id: 'C11-11', name: 'High-Decibel Siren Buzzer', image: '/img/kits/components/class11_part_11.jpg', role: 'Acoustic intrusion and alarm annunciator.', session: 'Session 7', category: 'Audio Output', specs: 'Active 5V piezo siren' },
      { id: 'C11-12', name: 'Tactile Latch Clear Switch', image: '/img/kits/components/class11_part_12.jpg', role: 'Human push button to reset latched alarm states.', session: 'Session 8', category: 'Input Switch', specs: '12mm tactile button' },
      { id: 'C11-13', name: 'HC-SR04 Sonar Distance Sensor', image: '/img/kits/components/class11_part_13.jpg', role: 'Instrument characterised in Unit 4 for error, precision, systematic drift, and uncertainty.', session: 'Session 9', category: 'Sensor', specs: 'Precision ultrasonic sensor module' },
      { id: 'C11-14', name: 'Triple IR Maze Sensor Array (Left, Centre, Right)', image: '/img/kits/components/class11_part_14.jpg', role: 'Three dedicated infrared reflective sensors that detect maze walls and paths in real-time.', session: 'Session 12', category: 'Navigation Sensor Array', specs: '3x TCRT5000 sensors with independent sensitivity adjustments' },
      { id: 'C11-15', name: 'L298N High-Torque Motor Driver', image: '/img/kits/components/class11_part_15.jpg', role: 'Power stage providing bidirectional PWM speed and direction control to drive motors.', session: 'Session 13', category: 'Motor Driver', specs: 'Dual H-bridge driver with thermal overload protection' },
      { id: 'C11-16', name: 'Autonomous Maze Solver Chassis & Battery Power', image: '/img/kits/components/class11_part_16.jpg', role: 'High-rigidity chassis, dual DC motors, precision caster wheel & high-capacity battery holder.', session: 'Session 13', category: 'Chassis & Power', specs: 'Heavy-duty acrylic chassis, 2x gear motors, rubber wheels, 4xAA power unit' }
    ]
  }
};
